      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-14 h-14 bg-accent/20 rounded-2xl mb-4 group-hover:bg-accent/30 transition-colors">
                <stat.icon className="w-7 h-7 text-accent-light" />
              </div>
              <div className="text-4xl sm:text-5xl font-bold text-white mb-2">
                {stat.value}
              </div>
              <div className="text-accent-light font-semibold mb-1">
                {stat.label}
              </div>
