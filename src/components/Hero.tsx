...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
      ...
      {/* Floating Elements */}
      <div className="absolute top-40 right-20 w-72 h-72 bg-blue-400/10 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-40 left-10 w-96 h-96 bg-blue-600/5 rounded-full blur-3xl animate-float" style={{ animationDelay: "1.5s" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-100 rounded-full px-4 py-2">
              ...
              <span className="text-blue-800 text-sm font-medium">13+ İllik Təcrübə</span>
            </div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-100 to-blue-50 rounded-3xl p-2 shadow-2xl">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-[#0f172a]">13+</div>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-lg font-bold text-[#0f172a]">24/7</div>
