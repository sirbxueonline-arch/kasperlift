        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="text-center">
              <span className="inline-block text-accent-light font-semibold text-sm tracking-wider uppercase mb-4">Niyə KasperLift?</span>
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                Azərbaycanın Aparıcı Lift
                <span className="text-accent-light"> Şirkəti</span>
              </h2>
            ...
            <div className="pt-6 border-t border-white/10 text-center">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                {certificates.map((cert, index) => (
                  ...
                  >
                    <Check className="w-4 h-4 text-accent-light mr-2" />
                    {cert}
                  </span>
                ))}
              </div>
