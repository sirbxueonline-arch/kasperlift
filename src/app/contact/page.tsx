        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Telefon</h3>
              <div className="space-y-2">
                <div>
                  <p className="text-sm text-gray-500">Satış</p>
                  <a href="tel:+994502096440" className="text-blue-600 font-semibold hover:underline">
                    +994 50 209 64 40
                  </a>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Texniki</p>
                  <a href="tel:+994772725050" className="text-blue-600 font-semibold hover:underline">
                    +994 77 272 50 50
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
              ...
              <h3 className="text-xl font-bold text-[#0f172a] mb-4">Ünvan</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-lg">
              <h2 className="text-2xl font-bold text-[#0f172a] mb-2">Bizə Yazın</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-lg">
                <div className="aspect-video bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <h3 className="text-xl font-bold text-[#0f172a] mb-2">Xəritədə Göstər</h3>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#0f172a]">İş Saatları</h3>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span className="font-semibold text-[#0f172a]">Bağlı</span>
                  </div>
